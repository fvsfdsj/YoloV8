...
from  ultralytics.nn.CBAM import SpatialAttention
from  ultralytics.nn.GAM多层 import GAM_Attention
from  ultralytics.nn.SEAttention import SEAttention
from  ultralytics.nn.SplitAttention import SplitAttention
from  ultralytics.nn.SGE import SpatialGroupEnhance
from  ultralytics.nn.NAMAttention import NAMAttention
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
            ...
            args = [ch[f]]
        elif m in {MHSA,ShuffleAttention, CoordAtt, CBAMBlock, SpatialAttention, GAM_Attention, SEAttention, SplitAttention, SpatialGroupEnhance, NAMAttention}:
            args = [ch[f], *args]
        elif m is Concat:
